...
-- Copy-paste
-- Don't want to deal with registers ATM, system-level register like GUI program works for now
...
map("n", "<C-p>",  function() require("dial.map").manipulate("decrement", "normal") end)
map("n", "g<C-p>", function() require("dial.map").manipulate("decrement", "gnormal") end)
map("x", "<C-p>",  function() require("dial.map").manipulate("decrement", "visual") end)
map("x", "g<C-p>", function() require("dial.map").manipulate("decrement", "gvisual") end)
